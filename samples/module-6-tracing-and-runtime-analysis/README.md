...
An excerpt from the native_sim trace data, configured in CTF and rendered by
Babeltrace2 (includes sched_lock and sched_unlock events):

```
 286 [00:00:00.490000000] (+0.000000000) timer_expiry_enter: { id = 134613892 }
 287 [00:00:00.490000000] (+0.000000000) timer_expiry_exit: { id = 134613892 }
 288 [00:00:00.490000000] (+0.000000000) isr_exit: 
 289 [00:00:00.490000000] (+0.000000000) idle: 
 290 [00:00:00.500000000] (+0.010000000) isr_enter: 
 291 [00:00:00.500000000] (+0.000000000) timer_expiry_enter: { id = 134612140 }
 292 [00:00:00.500000000] (+0.000000000) thread_sched_lock:  
 293 [00:00:00.500000000] (+0.000000000) msgq_put_enter: { id = 134612216, timeout = 0 }
 294 [00:00:00.500000000] (+0.000000000) thread_sched_ready: { thread_id = 134612544, name = "control" }
 295 [00:00:00.500000000] (+0.000000000) msgq_put_exit: { id = 134612216, timeout = 0, ret = 0 }
 296 [00:00:00.500000000] (+0.000000000) semaphore_give_enter: { id = 134612260 }
 297 [00:00:00.500000000] (+0.000000000) thread_sched_ready: { thread_id = 134612384, name = "maintenance" }
 298 [00:00:00.500000000] (+0.000000000) semaphore_give_exit: { id = 134612260 }
 299 [00:00:00.500000000] (+0.000000000) named_event: { name = "msg_ready", arg0 = 1, arg1 = 0 }
 300 [00:00:00.500000000] (+0.000000000) thread_sched_unlock: 
 301 [00:00:00.500000000] (+0.000000000) timer_expiry_exit: { id = 134612140 }
 302 [00:00:00.500000000] (+0.000000000) timer_expiry_enter: { id = 134613892 }
 303 [00:00:00.500000000] (+0.000000000) timer_expiry_exit: { id = 134613892 }
 304 [00:00:00.500000000] (+0.000000000) isr_exit: 
 305 [00:00:00.500000000] (+0.000000000) thread_switched_out: { thread_id = 134614848, name = "idle" }
 306 [00:00:00.500000000] (+0.000000000) thread_switched_in: { thread_id = 134612384, name = "maintenance" }
 307 [00:00:00.500000000] (+0.000000000) semaphore_take_exit: { id = 134612260, timeout = 4294957296, ret = 0 }
 308 [00:00:00.500000000] (+0.000000000) thread_busy_wait_enter: { usec_to_wait = 300000 }
```

Since the app is written to run indefinitely, trace data was started and then
stopped after some short, human period of time, such as ten or twenty seconds.
Trace data could be taken for arbitrary long time periods.

Zephyr trace facility never did fully function on real hardware.  Trace data
was captured, and looked qualitatively similar in internal form to the trace
data generated by the native_sim application.  Trace data files looked
similar internally, between the two files generated.

The author spent a couple of hours working to obtain good CTF data rendering
from the app running on the Nucleo board, but couldn't find a solution in that
time.
